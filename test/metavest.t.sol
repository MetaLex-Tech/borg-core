...
import "../src/libs/conditions/multiTimeCondition.sol";
import "../lib/MetaVesT/src/BaseAllocation.sol";
import "../lib/MetaVesT/src/VestingAllocation.sol";
//import metavest factories
import "../lib/MetaVesT/src/VestingAllocationFactory.sol";
import "../lib/MetaVesT/src/TokenOptionFactory.sol";
import "../lib/MetaVesT/src/RestrictedTokenFactory.sol";    
...
contract MetaVestTest is Test {
 ...
 // represents the DAO's On chain power address
  ...
  function setUp() public {
    ...
    mockERC20 = new MockERC20Stable("MockERC20Stable", "MERS");
    mockERC20.mint(address(MULTISIG), 1000000e18);
    vm.prank(dao);
    auth = new BorgAuth();
    ...
    deal(address(mockERC20), address(this), 1000000e18);
       ...
       vm.startPrank(MULTISIG);
        ...
        unlockTimes[2] = 1743944400;
        unlockTimes[3] = 1746536400;
        unlockTimes[4] = 1749214800;
        unlockTimes[5] = 1751806800;
        unlockTimes[6] = 1754485200;
        unlockTimes[7] = 1757163600;
        unlockTimes[8] = 1759755600;
        unlockTimes[9] = 1762434000;
        unlockTimes[10] = 1765026000;
        unlockTimes[11] = 1767704400;
        unlockTimes[12] = 1770382800;
        unlockTimes[13] = 1772802000;
        unlockTimes[14] = 1775480400;
