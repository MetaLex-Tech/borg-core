...
contract BaseScript is Script {
  ...
  address everclearDAOMultiSig = 0x68Ab3F79622cBe74C9683aA54D7E1BBdCAE8003C;
  ...
  address oracle = 0x7777777777777777777777777777777777777777;
  ...
  SnapShotExecutor snapShotExecutor;
    ...
    uint256 constant QUORUM_PERCENTAGE = 5; // 10% quorum
     ...
     function run() public {
            ...
            core = new borgCore(auth, 0x2, borgCore.borgModes(2), "EVERCLEAR GRANTS BORG", address(safe));
            ...
            address[] memory deadSigners = new address[](2);
